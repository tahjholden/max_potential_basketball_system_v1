            ...
            {pdp ? (
              <>
                ...
                <div className="mt-4 space-y-2">
                  <button onClick={onEditPDP} className="w-full border border-[#d8cc97] text-sm px-4 py-2 rounded font-semibold text-[#d8cc97] hover:bg-[#d8cc97]/10 transition">
                    Edit PDP
                  </button>
                  <button onClick={onArchivePDP} className="w-full border border-[#d8cc97] text-sm px-4 py-2 rounded font-semibold text-[#d8cc97] hover:bg-[#d8cc97]/10 transition">
                    Archive & Replace
                  </button>
                </div>
              </>
