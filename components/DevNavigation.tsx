...
const playerDevelopmentLinks = [
  {
    href: "/_dev/player-development",
    label: "Player Development",
    icon: Target,
  },
  {
    href: "/_dev/player-development-v2",
    label: "Player Development V2",
    icon: TrendingUp,
  },
];
    ...
    <nav className="flex flex-col h-full">
      <div className="flex-grow space-y-2">
        <div className="pt-4">
          ...
          <div className="space-y-2">{playerDevelopmentLinks.map(renderLink)}</div>
        </div>
